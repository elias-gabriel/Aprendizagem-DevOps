...
-- Inserir um jogador: nome, sobrenomme, apelido, datanascimentoYYYY-MM-DD, serie
...
-- Inserir estatísticas do jogo: partidaID, JogadorID, Cestasde2, Cestasde3, Faltas, CestasLivres
EXEC nba.InserirEstatisticasJogo 1, 9, 16, 12, 12, 2;
EXEC nba.InserirEstatisticasJogo 1, 10, 5, 19, 17, 0;

EXEC nba.InserirEstatisticasJogo 2, 7, 16, 5, 20, 0;
EXEC nba.InserirEstatisticasJogo 2, 11, 18, 14, 4, 1;

EXEC nba.InserirEstatisticasJogo 3, 8, 46, 99, 7, NULL;
EXEC nba.InserirEstatisticasJogo 3, 12, 14, 34, 2, null;
